 ...
 * {@link DetailFragment.DetailInteractionListener} interface
...
public class DetailFragment extends Fragment {
    ...
    private DetailInteractionListener mListener;
    ...
    public void onAttach(Context context) {
        ...
        if (context instanceof DetailInteractionListener) {
            mListener = (DetailInteractionListener) context;
        } else {
